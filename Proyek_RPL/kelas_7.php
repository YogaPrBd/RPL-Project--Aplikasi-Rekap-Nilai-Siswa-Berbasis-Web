...
<head>
    ...
    <title>Daftar Siswa Kelas 7| ReNi</title>
</head>
<body>
    <div class="container">
    ...
    <!-- Akhir Nav -->
        <div class="content">
            <h2 align="center">Daftar Siswa Kelas 7</h2>
            <br>
            <div class="batas"></div>
            <div class="for-btn d-flex justify-content-between">
	            ...
	            <a href="cetak/cetak_siswa7.php"><button type="button" class="btn_cetak"><i class="fa-regular fa-print"></i>Cetak</button></a>
            </div>
            <!-- <a href="daftar_siswa.php"><button type="button" class="btn_back"><i class="fa-solid fa-arrow-left"></i> Back</button></a> -->
            <br>
            <form class="d-flex" style="max-width: 50%;">
                ...
                <a href="kelas_7.php"><button type="link" class="btn btn-outline-secondary">Reset</button></a>
            </form>
                <br>
                <table class="table table-bordered table-striped table-hover">
                    <thead class="table-light">
                        <tr class="align-middle">
                            <th scope="col" style="width:2%; text-align:center;">NIS</th>
