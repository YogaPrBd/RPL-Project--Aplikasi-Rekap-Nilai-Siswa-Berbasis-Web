...
<head>
    ...
    <title>Daftar Siswa Kelas 8| ReNi</title>
</head>
<body>
    <div class="container">
    ...
    <!-- Akhir Nav -->
        <div class="content">
            <h2 align="center">Daftar Siswa Kelas 8</h2>
            <br>
            <div class="batas"></div>
            <div class="for-btn d-flex justify-content-between">
	            ...
	            <a href="cetak/cetak_siswa8.php"><button type="button" class="btn_cetak"><i class="fa-regular fa-print"></i>Cetak</button></a>
            </div>
            <br>
            <form class="d-flex" style="max-width: 50%;">
                <input class="form-control me-3" type="search" placeholder="Search" aria-label="Search">
                <button class="btn btn-outline-success" type="submit">Search</button>&nbsp;
                <a href="kelas_8.php"><button type="link" class="btn btn-outline-secondary">Reset</button></a>
            </form>
                <br>
